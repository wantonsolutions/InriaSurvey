...
\input{specverifdynamic}
\input{regularpatterns}
\input{sharedglobalstates}
\input{ontheflyanalysis}
\input{conjlocalpred}
\input{atomicseq}
\input{someoptimalalgorithms}
\input{predicatelocks}
\input{modelanalyzeandslice}
%\input{intro}
%\input{formal}
